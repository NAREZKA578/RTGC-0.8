# RTGC-0.8 — Real-Time Ground & air Combat Simulator

**RTGC-0.8** — это высокопроизводительный симулятор военной техники с реалистичной физикой, написанный на языке программирования **Rust**. Проект включает в себя продвинутую физику наземного транспорта и вертолётов, процедурную генерацию мира, многопоточную архитектуру и поддержку современных графических API.
...
git clone https://github.com/NAREZKA578/RTGC-0.8.git
cd RTGC-0.8
...
- Issues: [GitHub Issues](https://github.com/NAREZKA578/RTGC-0.8/issues)

---

**RTGC-0.8** — создан с использованием языка Rust для максимальной производительности и безопасности.
