...
impl InputAction {
    ...
    pub fn default_key_code(&self) -> Option<KeyCode> {
        match self {
            ...
            InputAction::LookUp | InputAction::LookDown | 
            InputAction::LookLeft | InputAction::LookRight => None, // Mouse only
...
mod tests {
    ...
    fn test_default_mapping() {
        ...
        assert_eq!(mapping.get_key_for_action(&InputAction::MoveForward), Some(KeyCode::KeyW));
    }
    ...
    fn test_rebinding() {
        ...
        assert_eq!(mapping.get_key_for_action(&InputAction::MoveForward), Some(KeyCode::ArrowUp));
        assert!(!mapping.is_action_bound(&InputAction::MoveForward) || 
