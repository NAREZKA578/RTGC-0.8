    ...
    pub fn new(
        ...
        let descriptor_sets = unsafe {
            device.allocate_descriptor_sets(&alloc_info)
                .map_err(|e| RhiError::ResourceCreationFailed(format!("Failed to allocate descriptor set: {:?}", e)))?
        };
...
impl VkDescriptorPool {
    ...
    pub fn new(
        ...
        let pool_sizes_vk: Vec<vk::DescriptorPoolSize> = pool_sizes
            .iter()
            .map(|&(ty, count)| vk::DescriptorPoolSize::builder().ty(ty).descriptor_count(count).build())
            .collect();
    ...
    #[cfg(feature = "vulkan")]
    pub fn free_sets(&self, device: &ash::Device, sets: &[vk::DescriptorSet]) {
        unsafe {
...
pub fn create_descriptor_set_layout(
    ...
    unsafe {
        device.create_descriptor_set_layout(&layout_info, None)
            .map_err(|e| RhiError::ResourceCreationFailed(format!("Failed to create descriptor set layout: {:?}", e)))
    }
}
