...
impl DayNightCycle {
    ...
    fn update_sun(&mut self, _dt: f32) {
        ...
        if height > 0.0 {
            ...
            self.sky_color_top = Vector3::new(0.05, 0.05, 0.15).lerp(&Vector3::new(0.4, 0.6, 0.9), t);
            self.sky_color_horizon = Vector3::new(0.1, 0.1, 0.2).lerp(&Vector3::new(0.7, 0.8, 0.9), t);
        }
    }
